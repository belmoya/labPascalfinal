program tema4.pas;
  ...
  var 
    contB,contL,contP,cont, centena, decena, unidad, cantnro, i: integer;
    tecnologia: char;
    codigo, digitocod: string;
  ...
  procedure INICIALIZACION;
    begin
      ...
      unidad:=0;
      cantnro:=0;
      assign(archsalida,'C:\\Users\\bmoyanesi\\OneDrive - Unimaco S.A\\Documentos\\ISI\\pascal-laboratorio\\archivo de salida.dat');
      assign(sec,'C:\\Users\\bmoyanesi\\OneDrive - Unimaco S.A\\Documentos\\ISI\\pascal-laboratorio\\secuencia de entrada.txt');
        assign(secsalida, 'C:\\Users\\bmoyanesi\\OneDrive - Unimaco S.A\\Documentos\\ISI\\pascal-laboratorio\\secuencia de salida.txt');
 //antes era .txt
      {$I-}
      reset(sec);
      {$I+}
